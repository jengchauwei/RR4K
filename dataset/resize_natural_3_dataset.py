...
class ResizeNatural3Dataset(BaseDataset):
    ...
    def __init__(self, opt, data_path, mode):
        ...
        if opt.phase == 'train':
            self.natural_dir_A1 = os.path.join(data_path, 'natural_' + 'T')
            self.natural_dir_B = os.path.join(data_path, 'natural_' + 'I')
        ...
        self.dir_A1 = os.path.join(data_path, opt.phase + 'A1')
        self.dir_A2 = os.path.join(data_path, opt.phase + 'A2')
        self.dir_B = os.path.join(data_path, opt.phase + 'B')
